...
- For a mass of 1969, the fuel required is 654. For a mass of 100756, the fuel 
required is 33583.
...
requires 654 fuel.
- Then, this fuel requires 216 more fuel (654 / 3 - 2). 216 then requires 70
more fuel, which requires 21 fuel, which requires 5 fuel, which requires no
further fuel. So, the total fuel required for a module of mass 1969 is 654 +
216 + 70 + 21 + 5 = 966. 
...
def test():
    ...
    for mass, fuel in test_inoutputs_part2:
        assert fuel == calc_fuel2(mass)
...
if __name__ == "__main__":
    ...
    # print answers.
    for i, func in enumerate((calc_fuel, calc_fuel2), 1):
        print("Answer {}:".format(i), answer(func))
